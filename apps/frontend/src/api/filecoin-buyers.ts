...
export const useBuyersControllerCreate = <
  TData = AsyncReturnType<typeof buyersControllerCreate, BuyerDto>,
  TError = unknown,
  TContext = unknown
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TContext
  >;
  request?: SecondParameter<typeof buyersControllerCreateMutator>;
}) => {
  const { mutation: mutationOptions, request: requestOptions } = options || {};

  return useMutation<TData, TError, { data: CreateBuyerDto }, TContext>(
    (props) => {
      const { data } = props || {};
...
export const getBuyersControllerFindAllQueryKey = () => [
  `/api/partners/filecoin/buyers`,
];

export const useBuyersControllerFindAll = <
  TQueryFnData = AsyncReturnType<typeof buyersControllerFindAll, BuyerDto[]>,
  TError = unknown,
  TData = TQueryFnData
>(options?: {
  query?: UseQueryOptions<TQueryFnData, TError, TData>;
  request?: SecondParameter<typeof buyersControllerFindAllMutator>;
}) => {
  const { query: queryOptions, request: requestOptions } = options || {};

  const queryKey =
    queryOptions?.queryKey ?? getBuyersControllerFindAllQueryKey();

  const query = useQuery<TQueryFnData, TError, TData>(
    queryKey,
    () => buyersControllerFindAll<TQueryFnData>(requestOptions),
    queryOptions
  );
...
export const getBuyersControllerFindOneQueryKey = (id: string) => [
  `/api/partners/filecoin/buyers/${id}`,
];

export const useBuyersControllerFindOne = <
  TQueryFnData = AsyncReturnType<typeof buyersControllerFindOne, BuyerDto>,
  TError = unknown,
  TData = TQueryFnData
>(
  id: string,
  options?: {
    query?: UseQueryOptions<TQueryFnData, TError, TData>;
    request?: SecondParameter<typeof buyersControllerFindOneMutator>;
  }
) => {
  const { query: queryOptions, request: requestOptions } = options || {};

  const queryKey =
    queryOptions?.queryKey ?? getBuyersControllerFindOneQueryKey(id);

  const query = useQuery<TQueryFnData, TError, TData>(
    queryKey,
    () => buyersControllerFindOne<TQueryFnData>(id, requestOptions),
...
export const buyersControllerUpdate = <TData = BuyerDto>(
  ...
  return buyersControllerUpdateMutator<TData>(
    {
      url: `/api/partners/filecoin/buyers/${id}`,
      method: 'patch',
      data: updateBuyerDto,
    },
    // eslint-disable-next-line
...
export const useBuyersControllerUpdate = <
  TData = AsyncReturnType<typeof buyersControllerUpdate, BuyerDto>,
  TError = unknown,
  TContext = unknown
>(options?: {
  mutation?: UseMutationOptions<
    TData,
    TError,
    { id: string; data: UpdateBuyerDto },
    TContext
  >;
  request?: SecondParameter<typeof buyersControllerUpdateMutator>;
}) => {
  const { mutation: mutationOptions, request: requestOptions } = options || {};
...
export const useBuyersControllerRemove = <
  TData = AsyncReturnType<typeof buyersControllerRemove, BuyerDto>,
  TError = unknown,
  TContext = unknown
>(options?: {
  mutation?: UseMutationOptions<TData, TError, { id: string }, TContext>;
  request?: SecondParameter<typeof buyersControllerRemoveMutator>;
}) => {
  const { mutation: mutationOptions, request: requestOptions } = options || {};
